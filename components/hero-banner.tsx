  ...
  return (
    <section className="relative w-full h-[85vh] min-h-[500px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-foreground leading-[1.1] tracking-tight text-balance">
          TOMIRIS COLLECTION
        </h1>
        <p className="mt-6 text-base md:text-lg text-foreground/70 font-light max-w-xl text-pretty tracking-wide">
          Искусство минимализма и вечная классика в каждом изделии
        </p>
        <a
          href="/catalog"
